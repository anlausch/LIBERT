...
python run_squad.py \
  ...
  --null_score_diff_threshold=-12.433086982928216


python $SQUAD_DIR/evaluate-v2.0.py $SQUAD_DIR/dev-v2.0.json $OUTPUT_DIR/squad2/base2/_8_3e-05_2.0/predictions.json >> $OUTPUT_DIR/squad2/base2/_8_3e-05_2.0/out.txt
