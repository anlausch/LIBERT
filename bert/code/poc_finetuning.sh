...
#VOCAB_DIR=$BERT_BASE_DIR/vocab_extended.txt
...
#BERT_CONFIG="/work/anlausch/replant/bert/code/bert_config_wn.json"
...
#CHECKPOINT=$BERT_WORDNET_DOUBLE_DIR/model.ckpt-100000

for task_name in "CoLA" "RTE" "QNLI" ; do
    echo $task_name
    ...
    --output_dir=$OUTPUT_DIR/base_new_reproduction/$task_name
    #--output_dir=$OUTPUT_DIR/base_new/$task_name
done
